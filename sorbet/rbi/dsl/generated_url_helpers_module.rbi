...
module GeneratedUrlHelpersModule
  ...
  def download_episode_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def download_movie_download_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_rails_conductor_inbound_email_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def episodes_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def movie_downloads_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def ptp_movie_recommendations_url(*args); end
