...
module GeneratedPathHelpersModule
  ...
  def download_episode_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def download_movie_download_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_rails_conductor_inbound_email_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def episodes_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def movie_downloads_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def ptp_movie_recommendations_path(*args); end
